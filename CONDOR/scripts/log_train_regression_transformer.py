...
PLOTS_DIR = ROOT_DIR + "plots/regression_transformer/"
MODEL_DIR = ROOT_DIR + "models/regression_transformer/"
...
Transformer.compile_model(
    ...
    loss={
        "normalized_regression": core.utils.MagnitudeDirectionLoss(log_mag=True),
